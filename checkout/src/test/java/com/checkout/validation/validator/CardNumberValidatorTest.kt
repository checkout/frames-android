...
internal class CardNumberValidatorTest {
    ...
    companion object {
        ...
        fun validationSuccessArguments(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of("6011601160116611", false, provideSuccess(CardScheme.DISCOVER)),
        ...
        fun eagerValidationSuccessArguments(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of("60110399", true, provideSuccess(CardScheme.DISCOVER)),
            Arguments.of("644111", true, provideSuccess(CardScheme.DISCOVER)),
            Arguments.of("65011111", true, provideSuccess(CardScheme.DISCOVER)),
            Arguments.of("60116011", true, provideSuccess(CardScheme.DISCOVER)),
            Arguments.of("6011", true, provideSuccess(CardScheme.DISCOVER)),
