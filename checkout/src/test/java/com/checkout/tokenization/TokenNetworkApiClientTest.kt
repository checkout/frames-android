...
internal class TokenNetworkApiClientTest {
    ...
    inner class GetCardTokenDetails {
        ...
        @Test
        fun informationExtractedFromResponse() =
            runTest {
                // Given
                enqueueMockResponse(
                    200,
                ...
                // When
                val response =
                    tokenNetworkApiClient.sendCardTokenRequest(
        ...
        fun apiRespondsWithError(errorCode: Int) =
            runTest {
                // Given
                enqueueMockResponse(
                    errorCode,
    ...
    inner class GetCVVTokenDetails {
        ...
        fun informationExtractedFromResponse() =
            runTest {
                ...
                // When
                val response =
                    tokenNetworkApiClient.sendCVVTokenRequest(
