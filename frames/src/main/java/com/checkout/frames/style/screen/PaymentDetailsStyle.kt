...
import com.checkout.frames.style.component.default.DefaultCardSchemeComponentStyle
...
public data class PaymentDetailsStyle(
    public var cardSchemeStyle: CardSchemeComponentStyle = DefaultCardSchemeComponentStyle.light(),
